            ...
            <Row>
                <Col md={3}>
                    ...
                    <div>
                        <ul>
                            <li>
                                <Link to={getFilterUrl({ category: 'all' })} className={'all' === category ? 'text-bold' : ''}>Any</Link>
                            </li>
                            {categories.map((c) => (
                                <li key={c}>
                                    <Link to={getFilterUrl({ category: c })} className={c === category ? 'text-bold' : ''}>
                                        {c}
                                    </Link>
                                </li>
                            ))}
                    ...
                    <div>
                        ...
                        <ul>
                            <li>
                                <Link to={getFilterUrl({ price: 'all' })} className={'all' === price ? 'text-bold' : ''}>Any</Link>
                            </li>
                            {prices.map((p) => (
                                <li key={p.value}>
                                    <Link to={getFilterUrl({ price: p.value })} className={p.value === price ? 'text-bold' : ''}>{p.name}</Link>
                                </li>
                            ))}
                        </ul>
                    </div>
